...
public class BuscarEquipamento extends javax.swing.JFrame {
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        ...
        patrimonio2 = patrimonio.getText();
        equi.setPatrimonio(patrimonio2);
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"Não foi cadastrado" + ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarEquipamento().setVisible(true);
            }
        });
    }
